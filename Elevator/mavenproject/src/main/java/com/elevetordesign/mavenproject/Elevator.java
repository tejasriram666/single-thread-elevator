...
public class Elevator {
	 ...
	 public Elevator() {    
		 this.currentFloor = 0;
		 //assumption the lift is starting from Ground        
		 this.currentDirection = Direction.UP;
		 //If at bottom , the lift will go up         
	 ...
	 public void start() throws InterruptedException { 
		  ...
		  //Assumption the lift is on ground floor initially      
		  do {           
			  System.out.println("--------");          
	  ...
	  private void processFloor(int floor) throws InterruptedException {
		  ...
		  currentFloorDestinations[floor] = false;
			  //Marked false as we are just arrived in the current floor     
			  moveElevator();  
			  }       
